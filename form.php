...
//
$mail_sys = "webmaster@conepoke.com";	// 管理者のメールアドレス
$from_name = "コネポケ事務局";	// メール送信者の表示
$from_mail = "webmaster@conepoke.com";	// メール送信者のメールアドレス（返信先）
$user_mail = "item2";	// 利用者にメールを送る場合のメールアドレス項目
//---
$title = "お問い合わせフォーム";
$subject = "お問い合わせ有難うございます（自動送信メール）\n";
$body = "このたびは、お問い合わせいただき誠に有難うございます。
以下の内容でお問い合わせを受け付けました。
\n";
$subject_sys = "フォームより問い合わせがありました\n";
$body_sys = "コネポケ問い合わせフォームより以下の問い合わせがありました。
\n";
$footer = "\n※このメールは自動送信されています。
...
━━━━━━━━━━━━━━━━━━━━━━
リサイクルでつながるアプリ
コネポケ https://www.conepoke.com/
―――――――――――――――――――――
運営会社 ELIYA Co., Ltd
https://www.conepoke.com/company/
━━━━━━━━━━━━━━━━━━━━━━";
//------------------------------------------------
